...
- Download and install the [Software R](https://ftp.fau.de/cran/). The latest version is currently `4.5.x` (December 2025).
...
If you're not familiar with programming in R, I suggest you work through my tutorial [Programming in R: An Introduction for Phoneticians](https://johannacronenberg.github.io/basic_R/setup.html)!
